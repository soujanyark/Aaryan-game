...
function setup() {
  ...
  welcome=createSprite(width/2,height/2);
...
bg=createSprite(width-400,height-400,400,400);
  ...
  dragon=createSprite(width-200,height-680,10,10);
  ...
  bo=createSprite(100,height-100,10,10);
  bo.addImage(boImage);
  bo.visible=false;
  bo.scale=0.9;
  ...
  dra=createSprite(width-200,height-750,10,10);
...
dra.visible=false;
  ...
  boom=createSprite(200,200,400,400);
  boom.addImage(boomImage);
  boom.visible=false;
  boom.scale=0.6;
  
  gameOver=createSprite(width-450,height-400,400,400);
...
function draw() {
  ...
  drawSprites();
    ...
    textSize(50);
  fill("red");
       text("Score:"+score,200,height-660);
